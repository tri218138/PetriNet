...
*/
        function arrowHeadAngle (x1, y1, x2, y2) {// hình ảnh mũi tên định vị lúc kéo
...
* For more info visit: https://github.com/DmitryBaranovskiy/raphael
*/
        function triangle (cx, cy, r) {// bán kính ngoại tiếp tam giác lúc kéo
            r *= 1.75;
